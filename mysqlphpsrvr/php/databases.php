<?php 
  ...
  $dbhost = "localhost:8080"; //Can be IP address, domain
...
<html lang="en">
  ...
  <body>
    ...
    ?>
      ...
      <li><?php echo $variant["variant_id"]; ?></li>
      <li><?php echo $variant["position"]; ?></li>
      <li><?php echo $variant["ref"]; ?></li>
      <li><?php echo $variant["alt"]; ?></li>
      <li><?php echo $variant["variant_class"]; ?></li>
      <li><?php echo $variant["mutation"]; ?></li>
    <?php>
      }
    ?>
